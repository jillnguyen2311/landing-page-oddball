...
export default function HeroSection() {
  return (
    <section className="bg-gray-900 text-white py-20 flex flex-col md:flex-row items-center justify-center text-center">
      <div className="container mx-auto md:w-1/2 flex flex-col items-center justify-center">
        ...
        <button className="px-8 py-3 mt-10 bg-green-600 text-white font-semibold rounded-md hover:bg-green-500 items-center justify-center">Get Started</button>
      </div>
